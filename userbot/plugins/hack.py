...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if idd==953414679:
            await event.edit("This is My Master\nI can't hack my master's Account\n**How dare you trying to hack my master's account nigger!**\n\n__Your account has been hacked! Pay 100$ and give Biology Practicals to the Peru__ [🔥Ninja Naveen🔥](http://t.me/ninjanaveen) __to release your account__😏")
        else:
